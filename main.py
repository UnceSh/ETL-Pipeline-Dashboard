...
username = "apikey-RZkDjHq5"
password = "RWBYVJ"
folder_path = r'C:\Users\Unce\Downloads\AdoptionETL\Data' # Folder we want to download files into
...
# Personal Data
# FTP Account Data
ftpHostname = "ftp.rescuegroups.org"
ftpUsername = "apikey-RZkDjHq5"
ftpPassword = "RWBYVJ"
ftpFolder_path = r'C:\Users\Unce\Downloads\AdoptionETL\Data' # Folder we want to download files into

# Database Account Data
dbHost = "localhost"
dbUsername = "root"
dbPassword = "MurderOfCrows5!"
...
def singleUseProcesses():
    ...
    inData = initialData(folder_path) # processes initial files into a single dataframe
    ...
    nData = newData(folder_path) # processes the new files into a single dataframe
...
def automaticProcesses():
    ...
    # Automatic processes
    update_files(ftpHostname, ftpUsername, ftpPassword, ftpFolder_path) # downloads files
    upData = updateData(folder_path) # processes the update files into a single dataframe
